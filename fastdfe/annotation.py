...
from .io_handlers import DummyVariant, MultiHandler, FASTAHandler, VariantReader, Variant
...
class _OutgroupAncestralAlleleAnnotation(AncestralAlleleAnnotation, ABC):
    ...
    def _setup(self, handler: MultiHandler):
        ...
        # set reader
        self._reader = self._handler.load_variants()
    ...
    def _parse_variant(self, variant: Variant) -> List[SiteConfig]:
        """
...
class MaximumLikelihoodAncestralAnnotation(_OutgroupAncestralAlleleAnnotation):
    ...
    def __init__(
        ...
        #: The VCF reader.
        self._reader: VariantReader | None = None
